...
class Bicicleta:
    ...
    def __init__(self, cor, modelo, ano, valor, aro=18):
        '''
        # self
        - refere ao objeto atual (explicito)
        - poderia ser utilizado outro nome, por convenção utiliza o self
        - usado para acessar variaveis/atributos que pertencem a classe
        - inicializa os atributos

        # Atributo
        - são como variaveis que pertencem a instancia de uma classe
